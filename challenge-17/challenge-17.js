(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Carlos Machel'));
  ...
  */
  ...
  var marco = 'março', setembro = 'setembro', dezembro = 'dezembro';

  console.log('O mês de ' + marco + ' representado pelo número '+ getMonthNumber( marco ) + '.')
  console.log('O mês de ' + setembro + ' representado pelo número '+ getMonthNumber( setembro ) + '.')
  console.log('O mês de ' + dezembro + ' representado pelo número '+ getMonthNumber( dezembro ) + '.')
  /*
