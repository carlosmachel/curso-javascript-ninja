...
*/
var pessoa = {nome: 'Carlos',
    sobrenome: 'Machel',
    sexo: 'Masculino',
    idade: 31, altura: 1.65,
    peso: 70,
    andando: false,
...
*/
pessoa.mostrarAltura = () => { return `Minha altura é ${pessoa.altura}`}
...
*/
pessoa.nomeCompleto() // "Olá! Meu nome é Carlos Machel"
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura() // "Minha altura é 1.65"
